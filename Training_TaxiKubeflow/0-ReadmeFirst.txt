...
Misc. 
        -> /Dockerfile  
            Contains the Dockerfiles used in this example 
        -> /yamls 
            Contains a copy of the yaml files that we load in for each container_op 
