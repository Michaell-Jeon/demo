...
#cli_input = json.loads('{"NumPreg":1.0,"Glucose":85.0,"BloodPressure":66.0,"SkinThick":29.0,"Insulin":0.0,"BMI":26.6,"DiabetesPedFunc":0.351,"Age":35.0}')
...
model = tf.keras.models.load_model(ProjectRepo('models/diabetes/db_remote.h5'), compile = False)
